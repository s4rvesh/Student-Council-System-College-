...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['first_name']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['college']) && !empty($_POST['dept']) && !empty($_POST['reciept_no']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])){
